...
export const buildTemplate = (
  ...
  if (tag === 'input' && !options.ngModel)
    options.ngModel = 'mpTestMomentObject';
...
export const getPicker = (element: ng.IAugmentedJQuery) =>
  (<IDirectiveScopeInternal>element.isolateScope()).picker;

// wrap jquery trigger fn: event trigger + digest stimulation
export const trigger = (
  element: ng.IAugmentedJQuery,
  event: string | JQueryEventObject
) => {
